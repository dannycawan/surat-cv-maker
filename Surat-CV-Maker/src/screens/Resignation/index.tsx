// In src/screens/Resignation/index.tsx, modify the renderHeader function and remove search state
...
type ResignationScreenNavigationProp = StackNavigationProp<RootStackParamList>;

const ResignationScreen = () => {
  const navigation = useNavigation<ResignationScreenNavigationProp>();
  ...
  const loadDrafts = async () => {
    setLoading(true);
    try {
      const draftsList = await getDraftList('resignation');
    ...
    Alert.alert(
      ...
      [
        ...
        },
        {
          ...
          onPress: async () => {
            try {
              await deleteDraft('resignation', draftId);
  ...
  const handleEditDraft = (draft: DraftItem) => {
    navigation.navigate('ResignationForm', { draftId: draft.id });
  };
  
  // Function to handle creating a new draft
  const handleCreateNewDraft = () => {
    navigation.navigate('ResignationForm', {});
  };
    ...
    return (
      <>
        ...
        <Animated.View style={[
          ...
          <Text style={styles.fixedHeaderTitle}>Surat Pengunduran Diri</Text>
        </Animated.View>
        ...
        >
          <View style={styles.headerContent}>
            <View>
              ...
              <Text style={styles.headerSubtitle}>Buat surat pengunduran diri profesional</Text>
            </View>
              ...
              <View style={styles.draftMeta}>
                <View style={styles.chipContainer}>
                  <Text style={styles.positionText}>
                    {item.data.position || 'Tidak ada posisi'}
                  </Text>
                </View>
      ...
      >
        <View style={styles.section}>
          <View style={styles.sectionHeader}>
            ...
            <Text style={styles.sectionSubtitle}>{drafts.length} surat pengunduran diri</Text>
          </View>
          ...
          {loading ? (
            ...
            <View style={styles.emptyContainer}>
              ...
              <Text style={styles.emptyText}>Buat surat pengunduran diri pertama Anda</Text>
              <Button 
                mode="contained" 
...
const styles = StyleSheet.create({
  ...
  draftCard: {
    ...
    borderRadius: 12,
    overflow: 'hidden',
    backgroundColor: theme.colors.white, // Explicitly set white background
  },
  draftHeader: {
    flexDirection: 'row',
