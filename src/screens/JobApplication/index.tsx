// In src/screens/JobApplication/index.tsx, modify the renderHeader function and remove search state
...
type JobApplicationNavigationProp = StackNavigationProp<RootStackParamList>;
...
const JobApplicationScreen = () => {
  ...
  const loadDrafts = async () => {
    setLoading(true);
    try {
      const draftsList = await getDraftList('jobApplication');
    ...
    Alert.alert(
      ...
      [
        ...
        },
        {
          ...
          onPress: async () => {
            try {
              await deleteDraft('jobApplication', draftId);
  ...
  const handleEditDraft = (draft: DraftItem) => {
    navigation.navigate('JobApplicationForm', { draftId: draft.id });
  };
  
  // Function to handle creating a new draft
  const handleCreateNewDraft = () => {
    navigation.navigate('JobApplicationForm', {});
  };
    ...
    return (
      <>
        ...
        <Animated.View style={[
          ...
          <Text style={styles.fixedHeaderTitle}>Surat Lamaran Kerja</Text>
        </Animated.View>
        ...
        >
          <View style={styles.headerContent}>
            <View>
              <Text style={styles.headerTitle}>Surat Lamaran Kerja</Text>
              <Text style={styles.headerSubtitle}>Buat surat lamaran kerja profesional</Text>
            </View>
      ...
      >
        <View style={styles.section}>
          <View style={styles.sectionHeader}>
            ...
            <Text style={styles.sectionSubtitle}>{drafts.length} surat lamaran</Text>
          </View>
          ...
          {loading ? (
            ...
            <View style={styles.emptyContainer}>
              ...
              <Text style={styles.emptyText}>Buat surat lamaran kerja pertama Anda</Text>
              <Button 
                mode="contained" 
